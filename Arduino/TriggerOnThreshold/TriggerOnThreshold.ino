...
//The default measurements are done at 10Hz
...
void setup() {
  ...
  initialReading = scale.get_units(INITIAL_SAMPLES);
  digitalWrite(LED, LOW);
}

void loop() {
  //Absolute Measurement float known_weight = 2000; //Weight of the thing you are measuring
  float current_reading=scale.get_units(LOOP_SAMPLES);  // get average of 5 scale readings
